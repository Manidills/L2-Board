...
def hour(timerange):
    url = f'https://www.coingecko.com/exchanges/1280/usd/{timerange}.json'
    headers = {
...
def cubiswap():
    ...
    with a :
        st.metric("Reported Trading Volume", "$1,665.33")

    with b:
        st.metric("Average Bid-Ask Spread", "0.634%")    
